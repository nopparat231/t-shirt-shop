...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2019 at 04:00 PM
...
-- Error reading data for table t_shirt_shop.tbl_admin: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `t_shirt_shop`.`tbl_admin`' at line 1
...
(113, 28, 'สีขาว/ม่วง', '', 150.00, 'ตัว', 'img132736269420191022_101254.png', '', '', '', '', 0, 0, 'M', 70, 0.00, '', '2019-10-22 03:25:34');
