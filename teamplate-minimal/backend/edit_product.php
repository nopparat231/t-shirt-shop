                      ...
                      <tr>
                        ...
                        <tr>
                          ...
                          <tr>
                            ...
                            <tr>
                              <td align="right" valign="middle">&nbsp;</td>
                              <td colspan="2">รูปที่&nbsp;5</td>
                            </tr>
                            <tr>
                              <td align="right" valign="middle">&nbsp;</td>
                              <td colspan="2"><img src="../pimg/<?php echo $row_eprd['p_img5']; ?>" width="100"></td>
                            </tr>
                            <tr>
                              <td align="right" valign="middle">แก้รูปที่5 :</td>
                              <td colspan="2"><label for="p_img5"></label>
                                <input name="p_img5" type="file"  class="bg-warning" id="p_img5" size="40" />
                                <input name="p_img55" type="hidden" id="p_img55" value="<?php echo $row_eprd['p_img5']; ?>"></td>
                              </tr>
                              <tr>
                                <td align="right" valign="middle">&nbsp;</td>
                                <td colspan="2">&nbsp;</td>
