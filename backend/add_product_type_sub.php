...
$ts_name = $_POST['t_name'];
$t_type = $_POST['t_type'];

if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "ptype")) {
  $insertSQL = sprintf("INSERT INTO tbl_type_sub (ts_name)VALUES ('$ts_name')");

mysql_select_db($database_condb);
  $Result1 = mysql_query($insertSQL, $condb) or die(mysql_error());

  $insertGoTo = "list_product_type_sub.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<html lang="en">
  ...
  <div class="container">
    ...
    <div class="col-md-9">
        <h3 align="center"> เพิ่มประเภทสินค้าย่อย </h3>
        <div class="table">
        <form action="add_product_type_sub.php" method="POST" name="ptype" id="ptype" class="form-horizontal">
        	<div class="form-group">
            	<div class="col-sm-3" align="right"> ประเภทสินค้าย่อย </div>
                <div class="col-sm-7">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                   ...
                   <a href="list_product_type_sub.php" type="btn" class="btn btn-danger">ยกเลิก</a>
                </div>
             </div>
