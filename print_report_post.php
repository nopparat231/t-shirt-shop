      ...
      <table border="0">
        <tr>
          ...
          <th width="553" nowrap="nowrap">
           ...
           <?php }else{ ?>
             <a href="" class="btn btn-success " target="_blank" id="hp" onclick="window.print();" >  <span class="glyphicon glyphicon-print"></span> พิมพ์ใบส่งสินค้า </a>
         ...
         <table width="416" border="0" cellpadding="0" cellspacing="0">
          ...
          <?php }else{ ?>
           <tr>
            <th width="406" align="center" scope="row"><h2 align="left"><strong>ใบส่งสินค้า</strong></h2>
   ...
   <tr>
    ...
    <th height="195" scope="row">
      <table width="489" border="0" style="text-align: left;">
        <tr>
          <th width="100" style="text-align: left;" scope="row"><p>&nbsp; &nbsp; เบอร์โทร</p></th>
          <td width="100" align="left" valign="bottom"><p><?php echo $row_cartdone['phone']; ?></p></td>
